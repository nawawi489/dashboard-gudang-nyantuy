...
const FileUpload = ({ label, onFileSelect, required = false }: FileUploadProps) => {
      ...
      {!preview ? (
        ...
        <div className="relative w-full h-48 bg-gray-100 rounded-lg overflow-hidden border border-gray-200">
          ...
          <div className="absolute top-2 right-2 bg-white/80 p-1 rounded-full shadow-sm">
            <button onClick={handleRemove} type="button" aria-label="Hapus" className="p-1 bg-red-100 text-red-600 rounded-full hover:bg-red-200 transition-colors">
              <X size={16} />
            </button>
          </div>
